  ...
  return (
    <div className="space-y-6 pt-4 pb-10">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs leading-relaxed text-mirai-text-note">
          本サイトは AFTTT
          が運営する民間の情報提供サイトであり、石垣市役所および
          石垣市議会の公式サイトではありません。本サイトで公開する情報は、可能な限り正確かつ最新の情報を反映するよう努めていますが、その正確性・完全性・即時性について保証するものではありません。また、AIチャットは不正確または誤解を招く回答を生成する可能性があります。正確な情報は、公式文書や一次資料をご確認ください。
        </p>
      </div>
